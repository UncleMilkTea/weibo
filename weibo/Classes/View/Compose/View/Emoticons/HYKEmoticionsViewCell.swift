...
//        backgroundColor = RandomColor()
        ...
        let ges = UILongPressGestureRecognizer(target: self, action: "longPressEmoticionsBtn:")
    ...
    private func addEmoticionsBtn(){
        ...
        for _ in 0..<EveryPageCount{
            ...
            btn.addTarget(self, action: "emoticionsBtnClick:", forControlEvents: .TouchUpInside)
...
//            btn.backgroundColor = RandomColor()
    ...
    private lazy var delButton:UIButton = {
        ...
        btn.addTarget(self, action: "deleteButtonClick", forControlEvents: .TouchUpInside)
